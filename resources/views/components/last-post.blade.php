                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="post_detail.html">
                            ...
                            <img class="img-fluid" src="images/post/post-4.webp" />
                        </a>
                    ...
                    <div class="col-md-6">
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <a href="post_detail.html">
                                    <img class="img-fluid" src="images/post/post-1.jpg" />
                                </a>
                            </div>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <a href="post_detail.html">
                                    <img class="img-fluid" src="images/post/post-2.jpg" />
                                </a>
                            </div>
                            <div class="col-md-8">
                                <h3 class="post-title fs-5">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <a href="post_detail.html">
                                    <img class="img-fluid" src="images/post/post-3.jpg" />
                                </a>
                            </div>
                            <div class="col-md-8">
                                <h3 class="post-title fs-5">
